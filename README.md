...
本项目采用 **Spec-Driven Development** 方法论，所有设计文档都公开在 `.kiro/specs/` 目录：

- **[需求文档](/.kiro/specs/multi-tenant-oncall-platform/requirements.md)** - 系统需求和验收标准
- **[设计文档](/.kiro/specs/multi-tenant-oncall-platform/design.md)** - 架构设计和技术选型
- **[任务列表](/.kiro/specs/multi-tenant-oncall-platform/tasks.md)** - 实现计划和优先级
- **[ADR 文档](/.kiro/specs/multi-tenant-oncall-platform/adr/)** - 架构决策记录
...
如果发现 Bug 或有功能建议，请[提交 Issue](../../issues)。
